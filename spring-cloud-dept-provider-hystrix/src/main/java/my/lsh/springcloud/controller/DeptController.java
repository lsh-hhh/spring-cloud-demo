...
//    @HystrixCommand(fallbackMethod = "hystrixCommandFind")
    ...
    public DeptEntity hystrixCommandFind(@PathVariable("id") Long id){
        DeptEntity deptEntity = new DeptEntity();
        deptEntity.setId(id);
        deptEntity.setName("找不到id为" + id + "的记录");
        deptEntity.setDataSource("无数据库");
        return deptEntity;
    }
